...
var CHART_LIST = [
    ...
    { id: 141, difficulty: { expert: 11.5, master: 13.5 }, name: "閃鋼のブリューナク" },
    ...
    { id: 441, difficulty: {               master: 13.8 }, name: "Kattobi KEIKYU Rider" },
    ...
    { id: 538, difficulty: {               master: 13.8 }, name: "AMAZING MIGHTYYYY!!!!" },
