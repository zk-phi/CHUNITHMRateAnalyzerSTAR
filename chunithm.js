...
var CHART_LIST = [
    ...
    { id:  34, difficulty: {                            }, name: "亡國覚醒カタルシス" },
    ...
    { id:  43, difficulty: {               master: 10.8 }, name: "太陽曰く燃えよカオス" },
    { id:  45, difficulty: {               master: 12.4 }, name: "L9" },
    { id:  46, difficulty: {               master: 10.9 }, name: "Bad Apple!! feat.nomico" },
    { id:  47, difficulty: {               master: 12.1 }, name: "六兆年と一夜物語" },
    ...
    { id:  76, difficulty: { expert: 11.9, master: 13.4 }, name: "luna blu" },
    { id:  77, difficulty: {               master: 12.8 }, name: "ケモノガル" },
    { id:  78, difficulty: {               master: 10.9 }, name: "crossing field" },
    ...
    { id: 109, difficulty: {               master: 10.7 }, name: "Emotions" },
    ...
    { id: 123, difficulty: {               master: 10.7 }, name: "橙の幻想郷音頭" },
    ...
    { id: 137, difficulty: { expert: 11.4, master: 13.7 }, name: "Angel dust" },
    ...
    { id: 152, difficulty: { expert: 11.8, master: 13.0 }, name: "Gustav Battle" },
    { id: 154, difficulty: {               master: 12.8 }, name: "SAVIOR OF SONG" },
    { id: 155, difficulty: {               master: 10.7 }, name: "ブルー・フィールド" },
    ...
    { id: 181, difficulty: {               master: 10.8 }, name: "ユクエシレズ" },
    ...
    { id: 244, difficulty: {               master: 12.2 }, name: "回レ！雪月花" },
    ...
    { id: 248, difficulty: { expert: 12.2, master: 13.9 }, name: "Schrecklicher Aufstand" },
    ...
    { id: 322, difficulty: { expert: 10.7, master: 13.6 }, name: "Imperishable Night 2006 (2016 Refine)" },
    ...
    { id: 354, difficulty: {               master: 12.2 }, name: "ラブリー☆えんじぇる!!" },
    { id: 355, difficulty: {                            }, name: "だんご大家族" },
    { id: 356, difficulty: {               master: 12.2 }, name: "クローバー♣かくめーしょん" },
    ...
    { id: 393, difficulty: { expert: 11.3, master: 13.8 }, name: "Dengeki Tube" },
    ...
    { id: 407, difficulty: { expert: 13.0, master: 14.1 }, name: "混沌を越えし我らが神聖なる調律主を讃えよ" },
    ...
    { id: 467, difficulty: {               master: 13.0 }, name: "Twice up Scenery" },
    ...
    { id: 471, difficulty: { expert: 11.8, master: 13.6 }, name: "極圏" },
    ...
    { id: 487, difficulty: {                            }, name: "-OutsideR:RequieM-" },
    ...
    { id: 492, difficulty: {               master: 12.6 }, name: "時の冒険者" },
