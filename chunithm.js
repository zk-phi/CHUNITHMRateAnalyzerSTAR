...
var CHART_LIST = [
    ...
    { id: 587, difficulty: {               master: 12.4 }, name: "クレッシェンド・ストーリー" },
    { id: 588, difficulty: {               master: 11.5 }, name: "Sentimental Snow" },
    { id: 589, difficulty: {               master: 12.9 }, name: "サンシャインサマー☆夏期講習" },
    { id: 590, difficulty: {               master: 12.6 }, name: "NYAN-NYA, More! ラブシャイン、Chu♥" },
