...
var CHART_LIST = [
    ...
    { id:  14, difficulty: {                            }, name: "コネクト" },
    { id:  18, difficulty: {                            }, name: "千本桜" },
    { id:  19, difficulty: {               master: 13.2 }, name: "DRAGONLADY" },
    ...
    { id:  36, difficulty: {                            }, name: "届かない恋 '13" },
    { id:  37, difficulty: {                            }, name: "鳥の詩" },
    { id:  38, difficulty: {                            }, name: "天ノ弱" },
    { id:  41, difficulty: {                            }, name: "sweet little sister" },
    ...
    { id:  65, difficulty: {                            }, name: "Anemone" },
    { id:  66, difficulty: {               master: 12.3 }, name: "明るい未来" },
    { id:  67, difficulty: {                            }, name: "昵懇レファレンス" },
    { id:  68, difficulty: {                            }, name: "乗り切れ受験ウォーズ" },
    ...
    { id:  74, difficulty: {                            }, name: "リリーシア" },
    { id:  75, difficulty: {                            }, name: "Counselor" },
    ...
    { id:  79, difficulty: {                            }, name: "ＧＯ！ＧＯ！ラブリズム♥" },
    ...
    { id:  89, difficulty: {                            }, name: "JET" },
    { id:  90, difficulty: { expert: 11.7, master: 13.5 }, name: "L'épisode" },
    { id:  91, difficulty: {                            }, name: "Yet Another ”drizzly rain”" },
    ...
    { id:  96, difficulty: {                            }, name: "チルノのパーフェクトさんすう教室" },
    { id:  97, difficulty: {                            }, name: "Help me, ERINNNNNN!!" },
    { id:  98, difficulty: {                            }, name: "魔理沙は大変なものを盗んでいきました" },
    { id:  99, difficulty: {               master: 11.7 }, name: "言ノ葉カルマ" },
    { id: 100, difficulty: {                            }, name: "After the rain" },
    { id: 101, difficulty: {               master: 13.0 }, name: "Tango Rouge" },
    ...
    { id: 113, difficulty: {                            }, name: "ストリーミングハート" },
    { id: 114, difficulty: {                            }, name: "Sweet Devil" },
    { id: 115, difficulty: {                            }, name: "Dreaming" },
    { id: 116, difficulty: {                            }, name: "君の知らない物語" },
    { id: 117, difficulty: {                            }, name: "M.S.S.Planet" },
    ...
    { id: 125, difficulty: {                            }, name: "Little Busters! ～TV animation ver.～" },
    { id: 126, difficulty: {                            }, name: "Heart To Heart" },
    ...
    { id: 133, difficulty: {                            }, name: "シリョクケンサ" },
    ...
    { id: 137, difficulty: {               master: 13.7 }, name: "Angel dust" },
    { id: 138, difficulty: {               master: 13.2 }, name: "conflict" },
    { id: 140, difficulty: {                            }, name: "Guilty" },
    ...
    { id: 145, difficulty: {                            }, name: "Change Our MIRAI！" },
    { id: 146, difficulty: {                            }, name: "夕暮れワンルーム" },
    { id: 147, difficulty: {                            }, name: "こころここから" },
    { id: 148, difficulty: {                            }, name: "Theme of SeelischTact" },
    { id: 149, difficulty: {                            }, name: "緋色のDance" },
    { id: 150, difficulty: {                            }, name: "brilliant better" },
    ...
    { id: 185, difficulty: {                            }, name: "楽園の翼" },
    { id: 186, difficulty: {                            }, name: "ってゐ！　～えいえんてゐVer～" },
    { id: 187, difficulty: {               master: 13.1 }, name: "患部で止まってすぐ溶ける～狂気の優曇華院" },
    ...
    { id: 196, difficulty: {               master: 13.7 }, name: "FREEDOM DiVE" },
    { id: 197, difficulty: {               master: 13.1 }, name: "Jack-the-Ripper◆" },
    ...
    { id: 223, difficulty: {               master: 13.0 }, name: "カミサマネジマキ" },
    { id: 224, difficulty: {                            }, name: "恋愛裁判" },
    ...
    { id: 232, difficulty: {               master: 13.5 }, name: "Elemental Creation" },
    ...
    { id: 245, difficulty: {                            }, name: "Help me, あーりん！" },
    { id: 246, difficulty: {               master: 12.8 }, name: "なるとなぎのパーフェクトロックンロール教室" },
    { id: 247, difficulty: {                            }, name: "絶世スターゲイト" },
    ...
    { id: 255, difficulty: {                            }, name: "激情！ミルキィ大作戦" },
    ...
    { id: 259, difficulty: {               master: 13.0 }, name: "Oshama Scramble! (Cranky Remix)" },
    ...
    { id: 263, difficulty: {                            }, name: "Hand in Hand" },
    ...
    { id: 286, difficulty: {                            }, name: "Tell Your World" },
    { id: 287, difficulty: {                            }, name: "ロミオとシンデレラ" },
    { id: 288, difficulty: {                            }, name: "First Twinkle" },
    { id: 289, difficulty: {               master: 12.6 }, name: "ウソラセラ" },
    { id: 290, difficulty: {                            }, name: "檄!帝国華撃団" },
    ...
    { id: 299, difficulty: {                            }, name: "secret base ～君がくれたもの～ (10 years after Ver.)" },
    { id: 300, difficulty: {               master: 12.2 }, name: "No Routine" },
    { id: 301, difficulty: {               master: 12.2 }, name: "白い雪のプリンセスは" },
    { id: 302, difficulty: {               master: 13.3 }, name: "Strahv" },
    { id: 303, difficulty: {                            }, name: "Dreams Dreams:Kids Ver." },
    { id: 304, difficulty: {                            }, name: "In The Blue Sky '01" },
    { id: 305, difficulty: {               master: 13.1 }, name: "幻想のサテライト" },
    { id: 306, difficulty: {               master: 12.2 }, name: "凛として咲く花の如く" },
    { id: 307, difficulty: {               master: 12.7 }, name: "Paqqin" },
    { id: 308, difficulty: {                            }, name: "fake!fake!" },
    { id: 309, difficulty: {               master: 12.5 }, name: "Rising Hope" },
    { id: 310, difficulty: {               master: 13.3 }, name: "覚醒楽奏メタフィクション" },
    { id: 311, difficulty: {                            }, name: "Be My Friend" },
    { id: 312, difficulty: {               master: 13.2 }, name: "ぶいえす!!らいばる!!" },
    { id: 313, difficulty: {                            }, name: "ひだまりデイズ" },
    { id: 314, difficulty: {                            }, name: "This game" },
    { id: 315, difficulty: {                            }, name: "オラシオン" },
    { id: 316, difficulty: {                            }, name: "みくみくにしてあげる♪【してやんよ】" },
    ...
    { id: 323, difficulty: {               master: 13.6 }, name: "Dreadnought" },
    ...
    { id: 328, difficulty: {               master: 13.8 }, name: "★LittlE HearTs★" },
    ...
    { id: 339, difficulty: {                            }, name: "RevolutionGame" },
    ...
    { id: 343, difficulty: {                            }, name: "Daydream café" },
    { id: 344, difficulty: {               master: 11.8 }, name: "ノーポイッ!" },
    { id: 345, difficulty: {                            }, name: "ムーンライト伝説" },
    { id: 348, difficulty: {                            }, name: "Jumping!!" },
    ...
    { id: 358, difficulty: {                            }, name: "My Soul,Your Beats!" },
    { id: 359, difficulty: {                            }, name: "Thousand Enemies" },
    ...
    { id: 377, difficulty: {                            }, name: "泡沫、哀のまほろば" },
    { id: 379, difficulty: {               master: 12.0 }, name: "愛き夜道 feat. ランコ、雨天決行" },
    { id: 380, difficulty: {                            }, name: "Starlight Dance Floor" },
    ...
    { id: 414, difficulty: {               master: 13.3 }, name: "We Gonna Party -Feline Groove Mix-" },
    { id: 416, difficulty: {               master: 12.4 }, name: "Through The Tower" },
    { id: 417, difficulty: {               master: 12.4 }, name: "Redo" },
    { id: 419, difficulty: {                            }, name: "SAKURAスキップ" },
    ...
    { id: 435, difficulty: {               master: 13.3 }, name: "JIGOKU STATION CENTRAL GATE" },
    ...
    { id: 466, difficulty: {               master: 13.7 }, name: "Iudicium" },
    ...
    { id: 470, difficulty: {               master: 13.5 }, name: "セイクリッド　ルイン" },
    ...
    { id: 476, difficulty: {                            }, name: "Just Be Friends" },
    { id: 477, difficulty: {                            }, name: "炉心融解" },
    ...
    { id: 496, difficulty: {               master: 13.3 }, name: "Hyper Active" },
    ...
    { id: 500, difficulty: {                            }, name: "プリズム" },
    { id: 501, difficulty: {               master: 11.5 }, name: "星灯" },
    { id: 502, difficulty: {                            }, name: "Clover Heart's" },
    { id: 503, difficulty: {                            }, name: "スイートマジック" },
    { id: 504, difficulty: {               master: 13.7 }, name: "Calamity Fortune" },
    { id: 505, difficulty: {                            }, name: "Melody！" },
    { id: 506, difficulty: { expert: 12.4, master: 13.6 }, name: "G e n g a o z o" },
    { id: 509, difficulty: {               master: 12.1 }, name: "Vitalization" },
    { id: 512, difficulty: {                            }, name: "フラジール" },
    ...
    { id: 522, difficulty: {                            }, name: "Philosophyz" },
    { id: 523, difficulty: {                            }, name: "虹色のフリューゲル" },
    ...
    { id: 529, difficulty: {                            }, name: "プレパレード" },
    { id: 530, difficulty: {               master: 11.5 }, name: "オレンジ" },
    { id: 531, difficulty: {                            }, name: "ホーリーナイト" },
    ...
    { id: 551, difficulty: {               master: 13.5 }, name: "Sparking Revolver" },
    { id: 552, difficulty: {               master: 13.8 }, name: "Gate of Doom" },
    { id: 553, difficulty: {                            }, name: "ダンスロボットダンス" },
    { id: 554, difficulty: {                            }, name: "アルカリレットウセイ" },
    { id: 555, difficulty: {                            }, name: "キレキャリオン" },
    { id: 556, difficulty: {                            }, name: "グラーヴェ" },
    { id: 557, difficulty: {                            }, name: "レトロマニア狂想曲" },
